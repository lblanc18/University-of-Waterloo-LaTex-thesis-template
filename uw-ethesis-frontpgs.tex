...
% Adds front matter to toc
\addcontentsline{toc}{front matter}{Examining Committee Membership \hfill}
...
% Adds front matter to toc  
\addcontentsline{toc}{frontmatter}{\bigskip \newline Acknowledegements \hfill}
...
\begin{acronym}
    % Add acronyms here with \acro{short}{long}
    % Use acronyms in document with \ac{short}
\end{acronym}
\cleardoublepage
\phantomsection		% allows hyperref to link to the correct page
